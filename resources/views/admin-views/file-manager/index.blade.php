                        ...
                        <div class="col-sm-2">
                            ...
                            <button class="btn w-100"  data-toggle="modal" data-target="#imagemodal{{$key}}" title="{{$file['name']}}">
                                <div class="gallary-card">
                                    <img src="{{str_replace('app/public','',asset('storage/app/'.$file['path']))}}" alt="{{$file['name']}}" style="height:auto;width:100%;">
                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <img src="{{str_replace('app/public','',asset('storage/app/'.$file['path']))}}" style="width: 100%; height: auto;" >
                                        </div>

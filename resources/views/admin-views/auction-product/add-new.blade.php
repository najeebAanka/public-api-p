...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{route('admin.auction-product.store')}}" method="POST"
...
@push('script')
    ...
    <script>
        ...
        add_more_customer_choice_option(1, "Size");
    ...
    <script>
        function check() {
            Swal.fire({
                ...
                $.post({
                    url: '{{route('admin.auction-product.store')}}',
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function (data) {

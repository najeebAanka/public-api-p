        ...
        @foreach ($combinations as $key => $combination)
            ...
            @if(strlen($str) > 0)
                <tr>
                    ...
                    <td>
                        <input type="text" name="us_{{ $str }}" class="form-control" required>
                    </td>
                    <td>
                        <input type="text" name="uk_{{ $str }}" class="form-control" required>
                    </td>
                    <td>
                        <input type="text" name="eu_{{ $str }}" class="form-control" required>
                    </td>
                    <td>
                    ...
                    <input type="hidden" name="user_{{ $str }}" value="{{auth('admin')->user()->id}}"
                           class="form-control">
                </tr>
            @endif
        @endforeach

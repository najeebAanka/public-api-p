...
@section('content')
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                            href="{{route('admin.auction-product.list', ['in_house', ''])}}">{{\App\CPU\translate('Product')}}</a>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{route('admin.auction-product.update',$product->id)}}" method="post"
                    ...
                    <div class="card mt-2 rest-part hidden">
                        <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-2 mb-2">
                                        <div class="customer_choice_options" id="customer_choice_options">
                                            @include('admin-views.auction-product.partials._choices',['choice_no'=>json_decode($product['attributes']),'choice_options'=>json_decode($product['choice_options'],true)])
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-12 pt-4 sku_combination" id="sku_combination">
                                        @include('admin-views.auction-product.partials._edit_sku_combinations',['combinations'=>json_decode($product['variation'],true)])
                                    </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <img style="width: 100%" height="auto"
                                                                 ...
                                                                 alt="Product image">
                                                            <a href="{{route('admin.auction-product.remove-image',['id'=>$product['id'],'name'=>$photo])}}"
...
@push('script_2')
    ...
    <script>
        ...
        function update_sku() {
            ...
            $.ajax({
                type: "POST",
                url: '{{route('admin.auction-product.sku-combination')}}',
    ...
    <script>
        function check() {
            ...
            $.post({
                url: '{{route('admin.auction-product.update',$product->id)}}',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {

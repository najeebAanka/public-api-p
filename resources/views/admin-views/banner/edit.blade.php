                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" id="id" name="id">
                                            <label for="name">{{ \App\CPU\translate('Subtitle')}}</label>
                                            <input type="text" name="subtitle" class="form-control" id="subtitle" value="{{$banner['subtitle']}}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select style="width: 100%"
                                                ...
                                                <option value="Contact Us" {{$banner['banner_type']=='Contact Us'?'selected':''}}>Contact Us</option>
                                                <option value="New Arrival" {{$banner['banner_type']=='New Arrival'?'selected':''}}>New Arrival</option>
                                                <option value="HOLIDAY" {{$banner['banner_type']=='HOLIDAY'?'selected':''}}>HOLIDAY</option>
                                                <option value="HOLIDAY SIDE" {{$banner['banner_type']=='HOLIDAY SIDE'?'selected':''}}>HOLIDAY SIDE</option>

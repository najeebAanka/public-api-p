        ...
        <div class="navbar-vertical-container">
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-brand-wrapper justify-content-between side-logo">
                    ...
                    <a class="navbar-brand m-auto" href="{{route('admin.dashboard.index')}}" aria-label="Front">
                        <img style="max-height: 38px;    width: 100% !important;"
...
{{--{{\App\Model\Order::where('branch_id', auth()->id())->Pos()->count()}}--}}
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/product/list/in_house')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.product.list',['in_house', ''])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Apparels Products')}}</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item {{Request::is('admin/auction-product/list/in_house')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.auction-product.list',['in_house', ''])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Shop Products')}}</span>
                                        </a>
                                    </li>
                    ...
                    <!--business settings ends here-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('web_&_app_settings'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/subscriptions*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.subscriptions.index')}}" title="">
                                    <i class="tio-book-bookmarked nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                {{\App\CPU\translate('Subscriptions')}}
                                            </span>
                                </a>
                            </li>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/terms-condition') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/testimonials*')?'active':''}}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                           href="{{route('admin.testimonials.add-new')}}" title="">
                                            <i class="tio-notice nav-icon"></i>
                                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                {{\App\CPU\translate('Testimonials')}}
                                            </span>
                                        </a>
                                    </li>
                                </ul>

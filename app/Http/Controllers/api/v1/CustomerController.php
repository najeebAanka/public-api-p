...
class CustomerController extends Controller
{
    public function info(Request $request)
    {
        return response()->json(['message' => 'Data Got!',
            'data' => \App\Resources\User::make($request->user())]);
    ...
    public function add_to_wishlist(Request $request)
    {
        ...
        if (empty($wishlist)) {
            ...
            $wishlist->save();
            return BackEndHelper::sendSuccess(translate('successfully added!'), '');
        }

        return BackEndHelper::sendSuccess(translate('Already in your wishlist'), '');
    }
    ...
    public function remove_from_wishlist(Request $request)
    {
        ...
        if (!empty($wishlist)) {
            ...
            return BackEndHelper::sendSuccess('successfully removed!', '');

        }
        return BackEndHelper::sendError([['message' => 'No such data found!']], 404);
    }
    ...
    public function wish_list(Request $request)
    {
        ...
        return BackEndHelper::sendSuccess('Data Got!',
            \App\Resources\Wishlist::collection($products)
        );
    }
    ...
    {
        return BackEndHelper::sendSuccess('Data Got!',
            Address::collection(ShippingAddress::where('customer_id', $request->user()->id)->get())
        );
    }
    ...
    public function delete_address(Request $request)
    {
        ...
        return BackEndHelper::sendError([['message' => translate('No such data found!')]], 404);
    }
    ...
    public function update_profile(Request $request)
    {
        ...
        return BackEndHelper::sendSuccess(translate('successfully updated!'), \App\Resources\User::make($user));
    }
    ...
    public function update_cm_firebase_token(Request $request)
    {
        ...
        return BackEndHelper::sendSuccess(translate('successfully updated!'), '');
    }
}

...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'testimonials', 'as' => 'testimonials.', 'middleware' => ['module:marketing_section']], function () {
            Route::get('add-new', 'TestimonialController@index')->name('add-new');
            ...
            Route::post('status', 'TestimonialController@status')->name('status');
            Route::post('delete', 'TestimonialController@delete')->name('delete');
        });

        Route::group(['prefix' => 'subscriptions', 'as' => 'subscriptions.', 'middleware' => ['module:marketing_section']], function () {
        ...
        Route::group(['prefix' => 'auction-product', 'as' => 'auction-product.', 'middleware' => ['module:product_management']], function () {
            Route::get('add-new', 'AuctionProductController@add_new')->name('add-new');
            Route::post('store', 'AuctionProductController@store')->name('store');
            Route::get('remove-image', 'AuctionProductController@remove_image')->name('remove-image');
            Route::post('status-update', 'AuctionProductController@status_update')->name('status-update');
            Route::get('list/{type}', 'AuctionProductController@list')->name('list');
            Route::get('stock-limit-list/{type}', 'AuctionProductController@stock_limit_list')->name('stock-limit-list');
            Route::get('get-variations', 'AuctionProductController@get_variations')->name('get-variations');
            Route::post('update-quantity', 'AuctionProductController@update_quantity')->name('update-quantity');
            //Route::get('list/{type}/{slug}', 'ProductController@list')->name('list');
            Route::get('edit/{id}', 'AuctionProductController@edit')->name('edit');
            Route::post('update/{id}', 'AuctionProductController@update')->name('update');
            Route::post('featured-status', 'AuctionProductController@featured_status')->name('featured-status');
            Route::get('approve-status', 'AuctionProductController@approve_status')->name('approve-status');
            Route::post('deny', 'AuctionProductController@deny')->name('deny');
            Route::post('sku-combination', 'AuctionProductController@sku_combination')->name('sku-combination');
            Route::get('get-categories', 'AuctionProductController@get_categories')->name('get-categories');
            Route::delete('delete/{id}', 'AuctionProductController@delete')->name('delete');

            Route::get('view/{id}', 'AuctionProductController@view')->name('view');
            Route::get('bulk-import', 'AuctionProductController@bulk_import_index')->name('bulk-import');
            Route::post('bulk-import', 'AuctionProductController@bulk_import_data');
            Route::get('bulk-export', 'AuctionProductController@bulk_export_data')->name('bulk-export');
        });
